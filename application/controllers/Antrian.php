...
class Antrian extends CI_Controller
{
	...
	public function cetak()
	{
		...
		$var_magin_left = 10;
		try {
			$p = printer_open('\\\192.168.2.62\POS1'); //work ip nya ip printer
			...
			printer_select_font($p, $font);
			printer_draw_text($p, "$jadwal",$var_magin_left, 210);
			printer_draw_line($p, $var_magin_left, 230, 400, 230);

			printer_draw_text($p, "Silahkan menunggu No antrian", $var_magin_left, 250);
			printer_draw_text($p, "Anda dipanggil kemudian", 50, 270);
			printer_draw_text($p, "masuk ke ruang sidang $ruang", 50, 290);

			printer_draw_text($p, "  ", $var_magin_left, 300);
